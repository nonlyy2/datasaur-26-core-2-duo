...
═══════════════════════════════════════════════════════
"Жалоба"
  — клиент недоволен качеством сервиса, обслуживанием, сроками
  — примеры: "недоволен работой", "ужасный сервис", "уже неделю не решают", "заблокировали без причины"

"Смена данных"
  — клиент хочет изменить персональные данные: номер телефона, email, паспорт, адрес
  — примеры: "хочу изменить номер", "смена телефона", "обновить паспортные данные", "удалить мои данные"

"Консультация"
  — клиент задаёт вопрос, хочет получить информацию, уточнить условия
  — примеры: "как купить акции", "какие комиссии", "можно ли дробно", "что такое ETF", "ИИН компании"

"Претензия"
  — клиент требует возврата денег, компенсации, выдвигает официальное требование
  — клиент угрожает судом, прокуратурой, правоохранительными органами, журналистами
  — примеры: "верните деньги", "подам в суд", "обращусь в прокуратуру", "125$ не пришло верните"

"Неработоспособность приложения"
  — технические проблемы: не входит в аккаунт, не приходит SMS/email, приложение не работает, ошибка при регистрации
...
"Мошеннические действия"
  ...
  — примеры: "не мошенники ли", "взломали аккаунт", "Money Advisor мошенники?", "проверьте сертификат"
...
═══════════════════════════════════════════════════════
10 — Претензия с угрозой суда/прокуратуры/правоохранителей
...
═══════════════════════════════════════════════════════
Определи ближайший офис из списка по полям country/oblast/city.
